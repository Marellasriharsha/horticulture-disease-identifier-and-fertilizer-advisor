...
filepath =('C:\Users\sriha\Downloads\Plant-Leaf-Disease-Prediction-main\Plant-Leaf-Disease-Prediction-main\model.h5')
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:\Users\sriha\Downloads\Plant-Leaf-Disease-Prediction-main\Plant-Leaf-Disease-Prediction-main\static\upload', filename)
        file.save(file_path)
